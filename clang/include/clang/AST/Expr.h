...
public:
  ...
  /// \param AnyAS If \c true, zero expressions of non-default-AS pointer type
  /// will be classed as NULL. By default, only zero expressions of a
  /// default-AS pointer type are considered.
  NullPointerConstantKind isNullPointerConstant(
      ASTContext &Ctx,
      NullPointerConstantValueDependence NPC,
      bool AnyAS = false) const;
