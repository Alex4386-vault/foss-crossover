...
public:
  ...
  /// Return the uniqued reference to the type for a latent address space
  /// qualified type with the specified type and address space.
  ///
  /// The resulting type has a union of the qualifiers from T and the latent
  /// address space. If T already has a latent address space specifier, it is
  /// silently replaced.
  QualType getLatentAddrSpaceQualType(QualType T, LangAS AddressSpace) const;
  ...
  QualType adjustFunctionType(QualType QT, FunctionType::ExtInfo EInfo);
  ...
  /// pointer types.
  QualType getDecayedType(QualType T, bool HonorASPragma = false) const;
  ...
  QualType getFunctionType(QualType ResultTy, ArrayRef<QualType> Args,
                           ...
                           Qualifiers qs = Qualifiers()) const;
...
public:
  ...
  QualType getTypeDeclType(const TypeDecl *Decl,
    ...
    if (PrevDecl) {
      assert(!PrevDecl->QualTypeForDecl.isNull() && "previous decl has no QualTypeForDecl");
      Decl->QualTypeForDecl = PrevDecl->QualTypeForDecl;
      return PrevDecl->QualTypeForDecl;
    }
...
public:
  ...
  bool hasSameCVRUnqualType(QualType lhs, QualType rhs) const;
  ...
  QualType getArrayDecayedType(QualType T, bool HonorASPragma = false) const;
...
public:
  ...
  bool typesAreCompatible(QualType T1, QualType T2,
                          ...
                          bool ForRedeclaration = false); // C99 6.2.7p1
