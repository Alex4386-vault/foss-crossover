...
class TypeDecl : public NamedDecl {
  ...
  mutable QualType QualTypeForDecl = QualType();
...
public:
  ...
  QualType getQualTypeForDecl() const { return QualTypeForDecl; }
  void setQualTypeForDecl(QualType TD) { QualTypeForDecl = TD; }
