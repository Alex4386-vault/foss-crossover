...
public:
  X86_64TargetInfo(const llvm::Triple &Triple, const TargetOptions &Opts)
    ...
    const bool IsWine32SP64 =
        getTriple().getEnvironment() == llvm::Triple::Wine32SP64;
    bool IsWinCOFF =
        getTriple().isOSWindows() && getTriple().isOSBinFormatCOFF();
    ...
    resetDataLayout(
        IsX32
            ...
            : IsWine32SP64
                ? IsWinCOFF
                    ? "e-m:w-p32:32:32-i64:64-f80:128-n8:16:32:64-S128"
                    : "e-m:e-p32:32:32-i64:64-f80:128-n8:16:32:64-S128"
                : IsWine32
                    ? IsWinCOFF
...
public:
  DarwinX86_64TargetInfo(const llvm::Triple &Triple, const TargetOptions &Opts)
    ...
    resetDataLayout(
        IsWine32SP64
            ? "e-m:o-p32:32:32-i64:64-f80:128-n8:16:32:64-S128"
            : IsWine32
