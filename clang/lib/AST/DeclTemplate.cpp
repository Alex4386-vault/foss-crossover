...
TemplateTypeParmDecl::Create(const ASTContext &C, DeclContext *DC,
  ...
  TTPDecl->setQualTypeForDecl(TTPType);
  return TTPDecl;
}
...
unsigned TemplateTypeParmDecl::getDepth() const {
  return getQualTypeForDecl()->getAs<TemplateTypeParmType>()->getDepth();
}

unsigned TemplateTypeParmDecl::getIndex() const {
  return getQualTypeForDecl()->getAs<TemplateTypeParmType>()->getIndex();
}

bool TemplateTypeParmDecl::isParameterPack() const {
  return getQualTypeForDecl()->getAs<TemplateTypeParmType>()->isParameterPack();
}
...
createMakeIntegerSeqParameterList(const ASTContext &C, DeclContext *DC) {
  ...
  // T ...Ints
  TypeSourceInfo *TI =
      C.getTrivialTypeSourceInfo(T->getQualTypeForDecl());
  ...
  TypeSourceInfo *TInfo = C.getTrivialTypeSourceInfo(
      TemplateTypeParm->getQualTypeForDecl());
